...
def violinplot(version, subset):
    ...
    # Save Violin Plots to Image Folder
    plt.savefig('../img/3-5-0-Q4-Plots/' +
                'violin_plot_'+subset+'.png', bbox_inches='tight')
...
def presentation_frequency_plot_figures(outcome):
    ...
    # Save Violin Plots to Image Folder
    if title == 'No Treatment/Transport Required Outcome Across Fire Station and Shift':
        title = 'No Treatment-Transport Required Outcome Across Fire Station and Shift'
    plt.savefig('../img/3-5-0-Q4-Plots/' +
